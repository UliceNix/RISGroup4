...
<body>
				...
				<%@ page
								import="java.sql.*,javax.portlet.ActionResponse.*, javax.swing.*, java.util.*, java.lang.*, java.io.*, java.text.*, java.net.*, org.apache.commons.fileupload.*,org.apache.commons.io.*, java.awt.Image.*, java.util.List, javax.imageio.*, java.awt.image.*, oracle.sql.*, oracle.jdbc.*"%>
				<% 
      ...
      try{
	   ...
	   response.sendRedirect("/proj1/homepage.jsp");
	    ...
	    out.println("Please input or select the path of the image!");
	      ...
	      out.println("<input type=submit name=Cancel value='No Images To Upload'><br>");
	      out.println("</form>");
