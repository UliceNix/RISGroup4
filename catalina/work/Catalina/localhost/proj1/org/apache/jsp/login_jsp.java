...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<TITLE>Welcome to RIS by US</TITLE>\r\n");
      out.write("</HEAD>\r\n");
      out.write("\r\n");
      out.write("<BODY>\r\n");
        ...
        if(request.getParameter("bLogin") != null)
        {
	        ...
	        if(passwd.equals(truepwd) && passwd != null && !passwd.isEmpty()){
		        out.println("<p><b>Your Login is Successful!</b></p>");
                        response.sendRedirect("/proj1/JSPExample1.jsp");
                }
        	else{
	        	out.println("<p><b>Either your userName or Your password is inValid. Please Try Again.</b></p>");
                }
